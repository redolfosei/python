...
class PasswordManager():
    ...
    def set_password(self,new_password):
        if new_password not in self.old_passwords:
            ...
            return "Password is taken! Use a new one!"     
        
    def get_password(self):
        return self.old_passwords[-1]
    
    def is_correct(self,checked_password):
        if checked_password == self.get_password():
            return True
        else:
            return False
        
pwd = PasswordManager()
pwd.set_password("kofi789")
print(pwd.old_passwords)
pwd.set_password("password789")
print(pwd.old_passwords)

print(pwd.get_password())     
    
print(pwd.is_correct("wwww")) #passing in an argument